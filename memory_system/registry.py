        ...
        return cls(
            [
                ...
                SlotDefinition(
                    ...
                    dynamics=StateDynamics.NOT_APPLICABLE,
                    coexistence_rule="mutually_exclusive",
                    exclusive_group="planning_preference",
                    reuse=0.88,
                    personalization_gain=0.94,
                    description="Preferred planning format.",
                    examples=("checklist",),
                ),
                SlotDefinition(
                    ...
                    dynamics=StateDynamics.NOT_APPLICABLE,
                    coexistence_rule="mutually_exclusive",
                    exclusive_group="learning_preference",
                    reuse=0.86,
                    personalization_gain=0.92,
                    description="Preferred explanation or learning mode.",
                    examples=("example_first", "principle_first"),
                ),
                SlotDefinition(
                    ...
                    dynamics=StateDynamics.NOT_APPLICABLE,
                    coexistence_rule="mutually_exclusive",
                    exclusive_group="collaboration_preference",
                    reuse=0.86,
                    personalization_gain=0.92,
                    description="Preferred collaboration stance.",
                    examples=("socratic", "challenge"),
                ),
                SlotDefinition(
                    ...
                    dynamics=StateDynamics.FLUID,
                    coexistence_rule="mutually_exclusive",
                    exclusive_group="planning_orientation",
                    reuse=0.82,
                    personalization_gain=0.9,
                    description="Evidence-accumulated planning mental model.",
                    examples=("prefers_checklists", "strategy_first"),
                ),
                SlotDefinition(
                    key="learning_style",
                    memory_type=MemoryType.PROFILE,
                    dynamics=StateDynamics.FLUID,
                    coexistence_rule="mutually_exclusive",
                    exclusive_group="learning_style",
                    reuse=0.82,
                    personalization_gain=0.9,
                    description="Evidence-accumulated learning mental model.",
                    examples=("example_first", "principle_first"),
                ),
                SlotDefinition(
                    key="cognitive_load_preference",
                    memory_type=MemoryType.PROFILE,
                    dynamics=StateDynamics.FLUID,
                    coexistence_rule="mutually_exclusive",
                    exclusive_group="cognitive_load_preference",
                    reuse=0.84,
                    personalization_gain=0.9,
                    description="Evidence-accumulated tolerance for cognitive load.",
                    examples=("low_load", "deep_dive"),
                ),
                SlotDefinition(
                    ...
                    dynamics=StateDynamics.FLUID,
                    coexistence_rule="mutually_exclusive",
                    exclusive_group="collaboration_style",
                    reuse=0.82,
                    personalization_gain=0.9,
                    description="Evidence-accumulated collaboration mental model.",
                    examples=("socratic", "challenge"),
                ),
                SlotDefinition(
                    ...
                    dynamics=StateDynamics.FLUID,
                    coexistence_rule="mutually_exclusive",
                    exclusive_group="uncertainty_tolerance",
                    reuse=0.76,
                    personalization_gain=0.84,
                    description="Evidence-accumulated tolerance for ambiguity.",
                    examples=("low", "high"),
                ),
                SlotDefinition(
                    key="risk_posture",
                    ...
                    dynamics=StateDynamics.FLUID,
                    coexistence_rule="mutually_exclusive",
                    exclusive_group="risk_posture",
                    reuse=0.68,
                    personalization_gain=0.78,
                    description="Evidence-accumulated risk posture; should remain policy-only.",
                    examples=("risk_averse",),
                    sensitive=True,
                ),
            ]
        )
